...
Each image is smaller because it only contains files for its specific architecture. The default executable is `everything-1.5.exe`, but you can override it using the `EVERYTHING_BIN` environment variable:
